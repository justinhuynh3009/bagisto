...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'form-login-text'     => 'Nếu bạn đã có tài khoản, sử dụng email của bạn để đăng nhập.',
            ...
            'title'               => 'Đăng nhập',
            'verify-first'        => 'Xác minh tài khoản email của bạn trước.',
        ],
        ...
        'signup-form' => [
            ...
            'success-verify'              => 'Tạo tài khoản thành công, đã gửi email xác minh.',
            'success-verify-email-unsent' => 'Tạo tài khoản thành công, chưa gửi email xác minh.',
            ...
            'verify-failed'               => 'Chúng tôi không thể xác minh email của bạn.',
        ],
    ...
    'components' => [
        ...
        'products' => [
            'card' => [
                ...
                'add-to-compare-success'      => 'Thêm vào danh sách so sánh thành công',
                'add-to-wishlist'             => 'Thêm vào danh sách yêu thích',
                'already-in-compare'          => 'Đã thêm vào danh sách so sánh',
                'new'                         => 'Mới',
    ...
    'products' => [
        ...
        'view' => [
            'type' => [
                'configurable' => [
                    'select-options'       => 'Vui lòng chọn',
                    'select-above-options' => 'Vui lòng chọn những lựa chọn trên',
                ],
            ...
            'compare'                => 'So sánh',
            'description'            => 'Mô tả',
            'related-product-title'  => 'Sản phẩm tương tự',
            'review'                 => 'Đánh giá',
    ...
    'checkout' => [
        'success' => [
            'info'          => 'Chúng tôi sẽ gửi email cho bạn, chi tiết đơn hàng và mã vận đơn',
        ...
        'cart' => [
            'continue-to-checkout'      => 'Thanh toán',
            ...
            'item-add-to-cart'          => 'Đã thêm vào giỏ hàng',
            ...
            'index' => [
                ...
                'empty-product'            => 'Giỏ hàng trống',
                'home'                     => 'Trang chủ',
                'items-selected'           => 'Đã chọn :count sản phẩm',
                'move-to-wishlist'         => 'Chuyển đến danh sách yêu thích',
                'move-to-wishlist-success' => 'Đã chuyển đến danh sách yêu thích',
                'price'                    => 'Gía',
                'product-name'             => 'Tên sản phẩm',
                'quantity'                 => 'Số lượng',
                'quantity-update'          => 'Đã cập nhật số lượng',
                'remove'                   => 'Xóa',
            ...
            'coupon'   => [
                'already-applied' => 'Đã áp dụng mã giảm giá',
                'applied'         => 'Đã áp dụng',
                'apply'           => 'Áp dụng mã giảm giá',
                'apply-issue'     => 'Mã giảm giá không thể sử dụng',
                'button-title'    => 'Áp dụng',
                'code'            => 'Mã giảm giá',
                'discount'        => 'Mã giảm giá',
                'enter-your-code' => 'Nhập mã giảm giá',
                'error'           => 'Có lỗi xảy ra',
            ...
            'mini-cart' => [
                ...
                'offer-on-orders'      => 'Nhận giảm giá đến 30% cho đơn hàng đầu tiên',
                'remove'               => 'Xóa',
                'see-details'          => 'Xem chi tiết',
        ...
        'onepage' => [
            'address' => [
                ...
                'save-address'     => 'Lưu thông tin vào sổ địa chỉ',
                'save'             => 'Lưu',
                'select-country'   => 'Quốc gia',
                'select-state'     => 'Chọn quận/huyện',
                'shipping-address' => 'Địa chỉ giao hàng',
                'state'            => 'Quận/Huyện',
